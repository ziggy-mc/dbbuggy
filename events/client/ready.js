...
const { setClient, startHeartbeat, seedSystems } = require("../../utils/systemMonitor");
...
module.exports = {
  ...
  async execute(client) {
    ...
    const updateStatus = () => {
      client.user.setActivity(`v1.2.4 | Tracking Bugs`, {
    ...
    seedSystems(client).catch((err) => client.logger.error("[SystemMonitor] seedSystems failed:", err));
  },
};
