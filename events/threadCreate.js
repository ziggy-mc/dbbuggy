...
async function generateUniqueBugId(guildId) {
    let id, exists;
    do {
        id = `bug-${randomLetters(3)}#${randomNumbers(4)}`;
...
module.exports = {
    ...
    async execute(thread, newlyCreated) {
        ...
        try {
            ...
            const maxActive = isSupporter ? 3 : 1;
            ...
            await fullThread.setName(bugId);
            ...
            const threadEmbed = new EmbedBuilder()
                ...
                .addFields(
                    { name: '📋 Bug ID', value: `\`${bugId}\``, inline: true },
                    { name: '📋 Original Title', value: originalTitle, inline: true },
